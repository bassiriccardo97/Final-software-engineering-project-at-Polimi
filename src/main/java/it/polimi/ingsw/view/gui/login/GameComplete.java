...
public class GameComplete {
    ...
    public GameComplete() {
        ...
        t7.setText("Oops! The game is already started or there are to many players, sorry." + "\n" + "Try to reload the game after few seconds.");
        ...
        vBox.getChildren().addAll(t1, t2, t3, t4, t5, t6, t7, pane4, reload);
        ...
        if (keyEvent.getCode() == KeyCode.ENTER) {
            try {
                if (!MyApplication.getClient().getStub().checkIfComplete()) {       //add for tcp
                    ...
                    MyApplication.getScene().setRoot(reloadGame.getBorderPane());
                }
